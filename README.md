...
- **观察**：离线数据解读与 20 页 HTML 数据演示，按社区概览、具体发现、总结与探索展开。覆盖规模分布、活跃时段、AI 工具、城市、职场、住房、理财与分享创造，展示实际收藏帖子、感谢帖子和感谢评论 Top 3，并补充案例语境。城市提及量不代表用户所在地，非完整年使用年度频率或相同月份对比。演示支持章节目录、全屏和页码链接，页码位于右下角；桌面适配单屏，手机可在正文区域滚动并展开数据说明。
